...
class rumah21 extends BaseController
{
  ...
  {
    $rumah21 = $this->Rumah21Model->getRumah21();
    ...
    // dd($kategoriWisata);
    return view('admin/kolaboratif/rumah21/data-rumah21', $data);
  }
  ...
  public function delete($id_rumah21)
  {
    $this->Rumah21Model->delete($id_rumah21);
    session()->setFlashdata('success', 'Data berhasil dihapus!');
    return redirect()->to('/rumah21')->withInput();
  }
