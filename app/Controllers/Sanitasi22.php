...
class sanitasi22 extends BaseController
{
  ...
  {
    $sanitasi22 = $this->Sanitasi22Model->getSanitasi22();
    ...
    $data = [
      ...
      'desa' => $desa,
      'kecamatan' => $kecamatan,
      'sanitasi22' => $sanitasi22,
      'menu' => "Kolaboratif",
    ];
    // dd($kategoriWisata);
    return view('admin/kolaboratif22/sanitasi22/data-sanitasi22', $data);
  }
