...
class sanitasi21 extends BaseController
{
  ...
  {
    $sanitasi21 = $this->Sanitasi21Model->getSanitasi21();
    ...
    $data = [
      ...
      'satuan' => $satuan,
      'sanitasi21' => $sanitasi21,
      'menu' => "Kolaboratif",
    ];
    // dd($kategoriWisata);
    return view('admin/kolaboratif/sanitasi21/data-sanitasi21', $data);
  }
  ...
  public function create()
  {
    ...
    return view('admin/kolaboratif/sanitasi21/create-sanitasi', $data);
  }
