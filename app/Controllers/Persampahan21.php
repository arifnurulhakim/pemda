...
class Persampahan21 extends BaseController
{
  ...
  {
    $persampahan21 = $this->Persampahan21Model->getPersampahan21();
    ...
    $data = [
      'title' => 'Daftar persampahan21',
      'subTitle' => 'persampahan21',
      ...
      'satuan' => $satuan,
      'persampahan21' => $persampahan21
    ];
    // dd($kategoriWisata);
    return view('admin/kolaboratif/persampahan21/data-persampahan21', $data);
  }
