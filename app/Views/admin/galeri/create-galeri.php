...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-700"><b>Tambah Data Galeri</b></h1>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="row mb-3">
                            <div class="col">
                                <label for="nama_gambar"><b>Nama Kegiatan</b></label>&nbsp;&nbsp;<span
                                    ...
                                    type="text" placeholder="" value="<?= old('nama_gambar'); ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <p>Preview Gambar<br>
                                    <img id="imgPreviewGaleri" width="200px" src="/img/galeri/default.jpg"
                                        class="img-thumbnail img-preview-galeri">
                                </p>
                            </div>
                        </div>
                        <button type='submit' class="btn btn-primary" href="/galeri/create">Tambah Data</button>
