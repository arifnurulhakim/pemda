...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-700"><b>Edit Data RPJMD 2022-2026</b></h1>

    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/rpjmd2126/update" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                    <div class="col">
                        <label for="id_misi"><b>Misi</b></label>&nbsp;&nbsp;<span class="badge badge-light bg-gray-200" style="color: grey;"><b>Wajib</b></span></label>
                        <select class="form-control " id="id_misi" name="id_misi">

                            <option value="">- Pilih Misi -</option>

                            <option value="" id="id_misi">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" style="width: 100%; background: #ffff;" name="nama_indikator" id="nama_indikator" onclick="" class="form-control " placeholder="-Pilih IKU / IKD-" readonly style="width:200px" />
                        <input type="hidden" name="id_ikudanikd1621" id="id_ikudanikd1621" class="form-control" />
