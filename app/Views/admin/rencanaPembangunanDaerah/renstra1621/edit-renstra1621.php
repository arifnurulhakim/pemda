...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/renstra1621/edit/<?= $id_renstra1621 ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control <?= $validation->hasError('id_pd') ? 'is-invalid' : ''; ?>" id="id_pd" name="id_pd">
                                    <?php foreach ($perangkatdaerah as $perangkatdaerah_1) : ?>
                                        <?php if ($id_perangkatdaerah == $perangkatdaerah_1['id_pd']) : ?>
 ...
 <div class="row mb-3">
 <div class="col">
                        <label for="nama_indikator"><b>Nama Indikator</b></label></label>&nbsp;&nbsp;<span class="badge badge-light bg-gray-200" style="color: grey;"><b>Wajib</b></span><input id="nama_indikator" name="nama_indikator" for="nama_indikator" class="form-control <?= $validation->hasError('nama_indikator') ? 'is-invalid' : ''; ?>" type="text" placeholder="" value="<?= $nama_indikator ?>">
                        <div class="invalid-feedback">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php foreach ($satuan as $satuan_1) : ?>
                                        <?php if ($id_satuan == $satuan_1['id_satuan']) : ?>
                ...
                <button class="btn btn-danger" type="reset" href="/renstra1621/index">Batal</button>
            </form>
        </div>
    </div>
</div>
