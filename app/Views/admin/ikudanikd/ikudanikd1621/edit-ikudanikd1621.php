...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-700"><b>Tambah Data IKU/IKD 2016-2021</b></h1>

    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/ikudanikd2126/update/<?= $result['id_ikudanikd2126']; ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <button type='submit' class="btn btn-primary" href="/ikudanikd2126/edit">Ubah Data</button>
