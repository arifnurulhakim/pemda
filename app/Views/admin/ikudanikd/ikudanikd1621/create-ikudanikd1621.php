...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/ikudanikd1621/save" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                    <div class="col">
                ...
                <button type='submit' class="btn btn-primary" href="/ikudanikd1621/create">Tambah Data</button>
