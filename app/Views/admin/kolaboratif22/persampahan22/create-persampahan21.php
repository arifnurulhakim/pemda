...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-700"><b>Tambah Data persampahan21 dan Penyehatan Lingkungan</b></h1>

    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="/persampahan21/save" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                    <div class="col">
                ...
                <button type='submit' class="btn btn-primary" href="/persampahan21/create">Tambah Data</button>
