...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Header -->
        <?= $this->include('views/front-templates/header'); ?>
        <!-- End of Header -->
    ...
    <script>
        function previewImgPengajuanEvent() {
            const gambarPengajuanEvent = document.querySelector('#gambar_event');
            const gambarPengajuanEventLabel = document.querySelector('.custom-file-label');
            const imgPreview = document.querySelector('.img-preview');

            gambarPengajuanEventLabel.textContent = gambarPengajuanEvent.files[0]
                .name; //sampul -> fiels -> index ke 0 -> namanya

            const fileGambarPengajuanEvent = new FileReader();
            fileGambarPengajuanEvent.readAsDataURL(gambarPengajuanEvent.files[0]);
            fileGambarPengajuanEvent.onload = function(e) {
