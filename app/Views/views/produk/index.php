    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li><a
                        href="<?php echo base_url('produk/p/').$produk->slug_kat ?>"><?php echo $produk->judul_kategori ?></a>
                </li>
                <li><a
                        href="<?php echo base_url('produk/p/').$produk->slug_kat."/".$produk->slug_subkat ?>"><?php echo $produk->judul_subkategori ?></a>
                </li>
                <li><a
                        href="<?php echo base_url('produk/p/').$produk->slug_kat."/".$produk->slug_subkat."/".$produk->slug_supersubkat ?>"><?php echo $produk->judul_supersubkategori ?></a>
                </li>
        ...
        <div class="col-lg-9">
            <h5><?php echo $produk->judul_produk ?></h5>
            <hr>
            <div class="row">
                <div class="col-sm-5">
                    <?php
		      ...
		      ?>
                ...
                <div class="col-sm-7">
                    ...
                    <p>Kategori:
                        ...
                        <a
                            href="<?php echo base_url('produk/p/').$produk->slug_kat."/".$produk->slug_subkat."/".$produk->slug_supersubkat ?>">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="isi_komentar" placeholder="Isikan pertanyaan Anda disini"
                            required></textarea>
                    </div>
                    <div class="form-group">
