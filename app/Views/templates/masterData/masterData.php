...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <?= $this->include('templates/masterData/sidebarMasterData'); ?>
    <!-- End of Sidebar -->
  ...
  <script>
    function previewFilePublikasiEdit() {
      const filePublikasi = document.querySelector('#file_publikasi');
      const proposalPublikasiLabel = document.querySelector('.custom-file-label');
      const filePreview = document.querySelector('.file-preview');
  ...
  <!-- iku ikd 1621 dropwdown searching -->
  <script>
    function myFunction() {
    ...
    function autofill_choose(id_satuan, nama_satuan) {
