...
class Tnimd21Model extends Model
{

  protected $table = 'tnimd21';
  protected $primaryKey = 'id_tnimd21';
  ...
  function countAll()
  {
    return $this->db->table('tnimd21')->countAll();
  }

  public function getTnimd21($slug = false)
  {
    if ($slug === false) {
      // $this->where(['slug' => $slug])->first();
      $this->join('perangkat_daerah', 'tnimd21.id_pd = perangkat_daerah.id_pd');
      $this->join('satuan', 'tnimd21.id_satuan = satuan.id_satuan');
      $this->join('kode_rekening', 'tnimd21.kode_rekening = kode_rekening.id_kode_rekening');
