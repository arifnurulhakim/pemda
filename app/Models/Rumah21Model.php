...
class Rumah21Model extends Model
{

  protected $table = 'rumah21';
  protected $primaryKey = 'id_rumah21';
  ...
  function countAll()
  {
    return $this->db->table('rumah21')->countAll();
  }

  public function getRumah21($slug = false)
  {
    if ($slug === false) {
      // $this->where(['slug' => $slug])->first();
      $this->join('perangkat_daerah', 'rumah21.id_pd = perangkat_daerah.id_pd');
      $this->join('satuan', 'rumah21.id_satuan = satuan.id_satuan');
      $this->join('kode_rekening', 'rumah21.kode_rekening = kode_rekening.id_kode_rekening');
