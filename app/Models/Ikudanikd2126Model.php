...
class Ikudanikd2126Model extends Model
{

  protected $table = 'ikudanikd2126';
  protected $primaryKey = 'id_ikudanikd2126';
  ...
  function countAll()
  {
    return $this->db->table('ikudanikd2126')->countAll();
  }

  public function getIkudanikd2126($slug = false)
  {
    if ($slug === false) {
